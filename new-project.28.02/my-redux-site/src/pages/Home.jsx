...
import { getItems, selectItem, resetSelection, deleteItem, updatePrice } from "../features/noodle/noodleSlice";

const Home = () => {
    const dispatch = useDispatch();
    const { items, status, selectedId } = useSelector(state => state.noodle);
